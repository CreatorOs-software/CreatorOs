...
export const MobileSidebar = ({
  ...
  return (
    <div
      className="h-12 px-4 flex flex-row md:hidden items-center justify-between bg-sidebar border-b border-border w-full"
      {...props}
    >
      <Link href="/dashboard" className="font-semibold text-sm text-foreground">
        Crextio
      </Link>
      <Menu
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center group/sidebar py-2 rounded-full",
