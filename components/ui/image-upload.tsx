  ...
  return (
    <div className="relative group rounded-lg overflow-hidden aspect-square bg-muted border border-border-light">
      ...
      <Button
        ...
        className="absolute top-1 right-1 size-5 rounded-full bg-background/80 backdrop-blur-sm text-foreground opacity-0 group-hover:opacity-100 transition-opacity hover:bg-background"
      >
        <X className="w-3 h-3" />
      </Button>
